...
func (k Keeper) AppendBitcannaid(
	...
	value := k.cdc.MustMarshalBinaryBare(&bitcannaid)
	store.Set(GetBitcannaidIDBytes(bitcannaid.Id), value)
...
// GetBitcannaidOwner returns the creator of the bitcannaid
