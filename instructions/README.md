...
11. **Check the sync:** while `catching_up = true` the node is syncing. Also you can compare your current block with the last synced block of another node or at our [Explorer](https://cosmos-explorer.bitcanna.io):
    ```
...
1. **You need coins:**
Send coins to your new address, you will need 1000000ubcna (1 BCNA) to run the validator and some more coins to perform TXs.
> How to get coins? -----
> How to swap your coins from our old Blockchain? -----
