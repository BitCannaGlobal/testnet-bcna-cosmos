...
```
>If you are familiar with the Cosmos environment, you can keep the daemon running while you are compiling/downloading and later make the upgrade in one command: 
```
...
## If you want to build from the source
 ...
 If you want to build the binary from the source, detailed instructions can be found in the [README](https://github.com/BitCannaGlobal/bcna/blob/main/1.install-compile.md#option-2-compile-instructions) of our GitHub:
```
